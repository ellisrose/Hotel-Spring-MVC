...
<html lang="en">
  ...
  <!-- END header -->
   ...
   <div class="container">
    	...
    	<h4>Order number: ${reservation.id}</h4>
    	<h4>Number of breakfast: ${reservation.price}</h4>
    	<h4>Number of lunch: ${reservation.checkIn}</h4>
    	<h4>Number of dinner: ${reservation.checkOut}</h4>
    	<hr>
    </div>
    <div class="heading">
