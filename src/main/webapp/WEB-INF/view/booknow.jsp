        ...
        <div class="row">
          <div class="col-md-6">
            <h2 class="mb-5">Reservation Form</h2>
                <form:form action="new" modelAttribute="reservation" method="post">
                  <div class="row">
                      <div class="col-sm-6 form-group">
                          
                          <label for="">Arrival Date</label>
                          <div style="position: relative;">
                            <input name="checkIn" type='date' class="form-control" id='arrival_date' />
                          </div>
                      </div>
                      ...
                      <div class="col-sm-6 form-group">
                          ...
                          <div style="position: relative;">
                            <input name="checkOut" type='date' class="form-control" id='departure_date' />
                          </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      ...
                      <select path="numRooms" name="numRooms" id="room" class="form-control">
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <select path="numGuests" name="numGuests" id="room" class="form-control">
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input path="email" name="email" type="email" id="email" class="form-control " />
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
              ...
              <figure>
                <img src="${pageContext.request.contextPath}/resources/images/img_1.jpg" alt="Generic placeholder image" class="img-fluid">
