...
<html lang="en">
  ...
  <!-- END header -->
        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            <div class="heading-wrap  element-animate">
              <h4 class="sub-heading">Enjoy your Stay</h4>
              <h2 class="heading">Search For Reservation</h2>
              <p class="">Enter Your Reservation Details</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <form:form action="saveRestReservation" modelAttribute="restReservation" method="POST" class="regform mt-4 needs-validation">
      	<div class="form-group">
          <label for="roomnum2">Number of Guests</label>
              <form:select id="roomnum" path="numGuests" class="form-control">
          ...
          <form:input type="time" id="reserve" path="time" class="form-control" />
      	</div>
      	<div class="form-group">
        	<p>Reservation Date:  </p>
            <form:input type="date" id="Check-out" path="date" class="form-control" />
      	</div>
      	<div class="form-group">
        	<p>Reservation Name:  </p>
            <form:input type="text" id="resName" path="checkOut" class="form-control" />
      	</div>
