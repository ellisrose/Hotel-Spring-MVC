...
<html lang="en">
  ...
  <!-- END header -->
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(${pageContext.request.contextPath}/resources/images/big_image_1.jpg);">
      <div class="container">
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-12 text-center">
			<form:form action="${pageContext.request.contextPath}/authenticateTheUser" method="POST">
	            <div class="mb-5 element-animate">
	              <h2 style="color: white; opacity:.7;">Login</h2>
	              ...
	              <a href="${pageContext.request.contextPath}/register/showRegistrationForm" class="newaccount" style="color: whitesmoke;">create account</a>
	            </div>
            </form:form>
            </div>
          </div>
